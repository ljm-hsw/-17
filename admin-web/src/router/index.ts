...
export const routes: RouteRecordRaw[] = [
  { path: '/login', name: 'login', component: LoginView },
  {
    ...
    children: [
      ...
      { path: 'visits', name: 'visits', component: () => import('../views/VisitsView.vue'), meta: { permission: 'visits.view_visitsession' } },
      { path: 'checkins', name: 'checkins', component: () => import('../views/CheckinsView.vue'), meta: { permission: 'visits.view_checkinevent' } },
